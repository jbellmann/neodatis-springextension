...
public class NeoDatisTransactionManagerTest {
	...
	public void testTransactionCommit() throws Exception {
		...
		Assert.assertFalse("Should not have a resource",
				TransactionSynchronizationManager.hasResource(odb));
	...
	public void testTransactionRollback() {
		final ODB odb = Mockito.mock(ODB.class);
		Mockito.when(odb.store(Mockito.isNull())).thenThrow(
		...
		try {
			tmpl.execute(new TransactionCallbackWithoutResult() {
				...
				protected void doInTransactionWithoutResult(
					...
					Assert.assertTrue(TransactionSynchronizationManager
							.hasResource(odb));
					NeoDatisTemplate neoDatisTemplate = new NeoDatisTemplate(
							odb);
					neoDatisTemplate.store(null);
				}
			});
